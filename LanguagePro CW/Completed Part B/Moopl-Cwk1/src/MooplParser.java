/* Generated By:JavaCC: Do not edit this line. MooplParser.java */
  ...
  Stm s;
    ...
    jj_consume_token(RCBR);
   {if (true) return new FunDecl(type, t.image, fs, ss, e);}
    throw new Error("Missing return statement in function");
  }
  ...
  List<Stm> ss = new LinkedList<Stm>();
    ...
    jj_consume_token(RCBR);
   {if (true) return new ProcDecl(t.image, fs, ss);}
    throw new Error("Missing return statement in function");
  }
    ...
    default:
      ...
      if (jj_2_2(2)) {
        ...
        case NEW:
          ...
          exp = nt_ExpList();
          jj_consume_token(RPAREN);
                                                           {if (true) return new ExpNewObject(t.image,exp);}
          break;
        case NOT:
 ...
 Token t;
  ...
  final public Stm nt_FRED(Exp e1) throws ParseException {
  Token t;
  Exp e2 ,e3;
  List<Exp> elist;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    ...
    case PERIOD:
      ...
      jj_consume_token(RPAREN);
      jj_consume_token(SEMICOL);
                                                                {if (true) return new StmCall(e1,t.image,elist);}
      break;
    default:
      jj_la1[20] = jj_gen;
      jj_consume_token(-1);
  ...
  List<Stm> statments = new LinkedList<Stm>();
    ...
    jj_consume_token(RCBR);
                                                     {if (true) return new StmBlock(statments);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public Exp nt_Tilak(Exp e1) throws ParseException {
  Token t;
  List<Exp> exp;
  Exp e2;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    ...
    default:
      ...
      if (jj_2_5(2)) {
        ...
        case PERIOD:
          ...
          exp = nt_ExpList();
          jj_consume_token(RPAREN);
                                                  {if (true) return new ExpCall(e1,t.image,exp);}
          break;
        default:
          jj_la1[23] = jj_gen;
